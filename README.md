...
- **VM Database**: Berfungsi sebagai tempat penyimpanan seluruh data pengguna dan informasi film. Komponen ini menggunakan **PostgreSQL** yang berjalan di dalam *container* Docker.
...
## Panduan Penggunaan VM (menggunakan Vagrant)
